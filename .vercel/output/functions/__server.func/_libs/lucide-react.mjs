...
const Battery = createLucideIcon("battery", __iconNode$D);
const __iconNode$C = [
...
const ChartLine = createLucideIcon("chart-line", __iconNode$A);
...
const CirclePlay = createLucideIcon("circle-play", __iconNode$w);
const __iconNode$v = [
  ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
...
const PanelTop = createLucideIcon("panel-top", __iconNode$h);
const __iconNode$g = [
  [
    "path",
    {
