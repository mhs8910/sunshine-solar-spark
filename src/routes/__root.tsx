...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    scripts: [
      {
        async: true,
        src: "https://www.googletagmanager.com/gtag/js?id=G-675C2BYVN7",
      },
      {
        children: `
...
function RootShell({ children }: { children: ReactNode }) {
  return (
    <html lang="en">
      <head>
        <HeadContent />
        <meta name="google-site-verification" content="MFpb5vS0KxI9mKbU-70iTVS89J7yP_44ySIB7d6Qx6s" />
        <script
      ...
      <body>
        {children}
        <noscript>
          <img height="1" width="1" style={{ display: 'none' }} src="https://www.facebook.com/tr?id=1176024467991038&ev=PageView&noscript=1" />
        </noscript>
        <Scripts />
      </body>
    </html>
