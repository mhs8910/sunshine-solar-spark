...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Sunshine Solar Energy — Premium Solar Installation in Lahore" },
      ...
      { name: "twitter:title", content: "Sunshine Solar Energy — Premium Solar Installation in Lahore" },
